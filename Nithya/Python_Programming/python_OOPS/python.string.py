...
# you can split by space, letter, dot etc
...
print("_"*50)
# replace method
str_g = "We Are Learning Python Programming Python Python Python Python "
output_g = str_g.replace("Python", "JAVA", 3) # 1 specify the count of python replace first python
